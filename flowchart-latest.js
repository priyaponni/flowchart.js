// flowchart.js, v1.7.0 - added roles
  ...
  \*********************************/
    ...
    function(module, exports, __webpack_require__) {
        function Symbol(chart, options, symbol) {
            ...
            this.roleText = this.getAttr("role"), font && this.text.attr({
                font: font
            ...
            if (this.group.push(this.text), symbol) {
                ...
                }), this.roleText && (this.circle = this.chart.paper.circle(symbol.getBBox().width - 20, 5, 10).attr({
                    stroke: this.roleText.stroke,
                    fill: this.roleText.fill,
                    "fill-opacity": this.roleText.opacity || 1
                }), this.circle.insertBefore(this.text), symbol.insertBefore(this.circle), this.group.push(this.circle)), 
                this.initialize();
            }
        }
        ...
        Symbol.prototype.getAttr = function(attName) {
            ...
            var x = 0;
            return this.roleText && (x = 5), this.group.getBBox().y + x;
